...
1. **正規表現によるパターンマッチング**(メールアドレス、電話番号、郵便番号、
   ...
   「Inc.」「Corp.」などの法人格を含む企業名、「山田太郎様」「スミス様」のように
   敬称(様・殿・氏)が付いた人物名も検出します)。
...
> 見出しやラベルのない表・自由記述のテキストでは機能しません。企業名・人物名の
> パターン検出も、法人格や敬称が付いていない書き方(例: 敬称なしの氏名だけの記載、
> 「(株)」のような略記)には対応していません。それらの場合の人物名・フリガナ・
> 住所・企業名などの検出はAIの判断精度に依存するため、
